...
from api.app.api.routers import health, jobs, gmail_oauth, gmail_watch, firestore_api
...
app.include_router(firestore_api.router, prefix="/api/firestore", tags=["firestore"])
